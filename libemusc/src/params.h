...
enum class SystemParam : int {
  ...
  Tune                = 0x0000,  // 4B: [0x0014 - 0x07e8 : 0x040000]-100.0-100.0
  Tune1               = 0x0001,
  Tune2               = 0x0002,
  Tune3               = 0x0003,
  ...
  RxSysEx             = 0x0085,  // [0 - 1 : 1]
  RxGMOn              = 0x0086,  // [0 - 1 : 1]
  RxGSReset           = 0x0087,  // [0 - 1 : 1]
  RxInstrumentChange  = 0x0088,  // [0 - 1 : 1]
  RxFunctionControl   = 0x0089,  // [0 - 1 : 1]
  DeviceID            = 0x0090   // [1 - 32 : 17]
};
...
enum class PatchParam : int {
  ...
  // Part 2: Settings outside SysEx chart
  // These settings are modified either by non-SysEx MIDI messages or LCD menu
